...
<header class="text-gray-600 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
      <a href="https://rickandmortyapi.com/documentation" class="mr-5 hover:text-gray-900" target="_blank">API Documentation</a>
    </nav>
    <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
      <img src={RickLogo} alt="Rick Sanchez" />
      <span class="ml-3 text-xl">Rick and Morty</span>
      <img src={MortyLogo} alt="Morty Smith" />      
    </a>
    <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      <a href="http://github.com/rickandmortyapi" target="_blank">
...
{/* end Header */}
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">     
      ...
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Rick and Morty API </h1>
      <p class=" mx-auto leading-relaxed text-base">Wubba lubba dub dub, Ingrese el nombre del personaje que desea buscar</p>
      ...
      <button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Buscar</button>
    </div>
  </div>
</section>
...
<footer class="text-gray-600 body-font">
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <img class="w-10 h-10 text-white p-2 bg-white-500 rounded-full"  src={ShipRyM} alt="ship Rick and Morty" />


      <span class="ml-3 text-xl">Rick and Morty</span>
    </a>
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 Informatorio Chaco 
